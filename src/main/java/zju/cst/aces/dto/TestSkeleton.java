...
/**
 * Build the code in the gpt reply into unit test code based on the test framework.
 */
@Data
public class TestSkeleton {
    ...
    /**
     * Adds a given test method to a unit test skeleton.
     * @param testMethod the unit test method to be built
     * @return constructed test class
     */
