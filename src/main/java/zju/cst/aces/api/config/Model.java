...
/**
 * Models that can be called in the GPT API.
 */
public enum Model {
    ...
    /**
     * Constrain the callable model type according to the initial model type.
     * If it is in the constraint class, it returns the information of the model.
