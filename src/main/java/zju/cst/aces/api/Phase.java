...
/**
 * Selectors for the five modules: {@link Preparation}, {@link PromptGeneration}, {@link TestGeneration}, {@link Validation}, and {@link Repair}.
 */
...
public class Phase {
    ...
    /**
     * Parse and analyze the current project according to config.
     */
    @AllArgsConstructor
    ...
    public class PromptGeneration {
        ...
        /**
         * Execution of the prompt word generator.
         * @param num The number of current loops
         * @return {@code pc} prompt word generator
         */
    ...
    /**
     * Generates unit test code for focal methods in the focal class.
     *
     * <P>
     * Use the prompt word generator and the receiver to call {@link  PromptGenerator#generateMessages} to generate prompt words for the system and the user.
     * Use the prompt word as a parameter to call {@link TestGeneration#generateTest} to request the gpt api.
     * Call {@link TestSkeleton#build} to build the unit test code, and use {@link  RepairImpl#ruleBasedRepair} to repair the unit test.
     * </P>
     */
    public class TestGeneration {
         ...
         * @param prompt prompt words for the system and the user
         * @param record Information recorder
    ...
    /**
     * Verify that the unit test code can be run.
     */
    @AllArgsConstructor
    ...
    /**
     * Based on LLM, the defective unit test code generated in the previous round is repaired.
     */
    @AllArgsConstructor
    public class Repair {
         ...
         * @param pc prompt word generator
         */
        public void execute(PromptConstructorImpl pc) {
